        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    <br />
                    <h1>Ubicación</h1>
                    <asp:GridView ID="gvUbicaciones" runat="server" CssClass="table-reposetive table table-border" EnableTheming="True" OnRowCommand="SeleccionarRegistro" OnSelectedIndexChanged="gvUbicaciones_SelectedIndexChanged">
                        <Columns>
